...
class ChangePasswordDialog {
                ...
                child: Column(
                  children: [
                    TextFieldApp(
                      ...
                      labelStyle: const TextStyle(fontSize: 16,color: ColorHelper.primaryColor2,fontFamily: FontsHelper.cairo),
  ...
  static void onSave({BuildContext? context}) {
    if (oldPassController.text.isEmpty ||
      ...
      ShowToastSnackBar.showSnackBars(context!, message: 'Old/New/Confirm password must be not empty');
      return;
    }
