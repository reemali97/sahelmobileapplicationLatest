        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  const [
              ...
              ListTileWidget(title: 'Personal Info',),
              Divider(color: ColorHelper.greyColor,),
              ListTileWidget(title: 'Job Info',),
              Divider(color: ColorHelper.greyColor,),
              ...
              ListTileWidget(title: 'Language',leadingIcon: Icons.language,),
              Divider(color: ColorHelper.greyColor,),
              ListTileWidget(title: 'Primary Color',leadingIcon: Icons.color_lens_outlined,),
              Divider(color: ColorHelper.greyColor,),
              ListTileWidget(title: 'Change Password',leadingIcon: Icons.lock_outline,),
              Divider(color: ColorHelper.greyColor,),
              ListTileWidget(title: 'Logout',textStyle: TextStyle(color: ColorHelper.redColor),leadingIcon: Icons.logout,),
            ],
          ),
        ),
      ),
